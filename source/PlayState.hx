...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var levelInfo:FlxText = new FlxText(20, 688, 0, "v0.7.0 - ", 32);
		levelInfo.setFormat(Paths.font("vcr.ttf"), 19, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		levelInfo.text += PlayState.SONG.song;
		levelInfo.scrollFactor.set();
		levelInfo.borderSize = 1.27;
		levelInfo.updateHitbox();
		add(levelInfo);

		var levelDifficulty:FlxText = new FlxText(20, 658, 0, "", 32);
		levelDifficulty.text += CoolUtil.difficultyString();
		levelDifficulty.scrollFactor.set();
		levelDifficulty.setFormat(Paths.font('vcr.ttf'), 19, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		levelDifficulty.borderSize = 1.27;
		levelDifficulty.updateHitbox();
		add(levelDifficulty);

		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "pov: your too lazy to play", 32);
		...
		levelDifficulty.cameras = [camHUD];
  ...
  public function clearShaderFromCamera(cam:String){
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			Txt.text = 'Score: ' + songScore + ' | Combo Breaks: ' + songMisses + ' | Accuracy: ' + ratingName;
		} else {
